...
class Ui_Upload(object):
    def setupUi(self, Upload):
        ...
        self.gridLayout_4.addWidget(self.progressBar, 2, 0, 1, 3)
        self.gridLayout_2.addLayout(self.gridLayout_4, 3, 0, 1, 1)
        self.buttonCalculator = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        self.buttonCalculator.setFont(font)
        self.buttonCalculator.setObjectName("buttonCalculator")
        self.gridLayout_2.addWidget(self.buttonCalculator, 4, 0, 1, 1)
    ...
    def retranslateUi(self, Upload):
        ...
        self.buttonCalculator.setText(_translate("Upload", "Калькулятор"))
